var tetopstr = ' <div class="navbar-header aside-md">\
            ...
            <div class="flleft">\
                <a class="btn btn-rounded btn-sm btn-twitter cd" href="#"><i class="fa fa-fw fa-envelope"></i>信息中心</a>\
                <a class="btn btn-rounded btn-sm btn-facebook cd" href="#"><i class="fa fa-fw fa-book"></i>我的办公桌</a>\
                <a class="btn btn-rounded btn-sm btn-gplus cd" href="#"><i class="fa fa-fw fa-folder"></i>文档中心</a>\
            </div>\
                    ...
                    <section class="dropdown-menu aside-xl">\
                        <section class="panel bg-white">\
                            <header class="panel-heading b-light bg-light">\
                                <strong>你有<span class="count" style="display: inline;">0</span>条消息</strong>\
                            </header>\
                            ...
                            <footer class="panel-footer text-sm">\
                                ...
                                <a data-toggle="class:show animated fadeInRight" href="#notes">查看所有消息</a>\
                            </footer>\
                        </section>\
                    </section>\
                </li>\
